...
# -*- coding: utf-8 -*-
"""
商品持仓量获取脚本 (Commodity Open Interest)
============================================

调用 Primit 数据中心的商品持仓量接口：
    GET https://api.pipai.org/commodity/v1/openInterest
...
----
    单个当前快照（非历史序列）：
        {"symbol": "XAUUSDT", "openInterest": "65773.589", "time": 1782393513725}
...
用法示例
--------
    python commodities/commodity_open_interest.py              # 默认 XAU
    python commodities/commodity_open_interest.py --symbol XAG
"""
...
BASE_URL = "https://api.pipai.org/commodity/v1/openInterest"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="获取 Primit 商品持仓量 (open interest)。",
