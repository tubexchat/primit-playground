...
# -*- coding: utf-8 -*-
"""
股票持仓量获取脚本 (Stock Open Interest)
========================================

调用 Primit 数据中心的股票持仓量接口：
    GET https://api.pipai.org/stock/v1/openInterest
...
----
    单个当前快照（非历史序列）：
        {"symbol": "NVDAUSDT", "openInterest": "185258.49", "time": 1782393490650}
    其中 time 为 Unix 毫秒。接口仅返回最新持仓量，period/limit 等参数无效。

用法示例
--------
    python stocks/stock_open_interest.py                # 默认 NVDA
    python stocks/stock_open_interest.py --symbol AAPL
"""
...
BASE_URL = "https://api.pipai.org/stock/v1/openInterest"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="获取 Primit 股票持仓量 (open interest)。",
