...
# -*- coding: utf-8 -*-
"""
股票 K 线获取脚本 (Stock Klines)
================================

调用 Primit 数据中心的股票 K 线接口：
    GET https://api.pipai.org/stock/v1/klines
...
注意
----
    接口路径为 ``stock``（单数），与本目录名 ``stocks`` 不同。

用法示例
--------
    python stocks/stock_klines.py                            # 默认 NVDA, 1d, 100 根
    python stocks/stock_klines.py --symbol AAPL --interval 1h --limit 50
    python stocks/stock_klines.py --symbol NVDA --start 1782259200000 --end 1782345600000
"""
...
# 常量
# ---------------------------------------------------------------------------
BASE_URL = "https://api.pipai.org/stock/v1/klines"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="获取 Primit 股票 K 线 (stock klines)。",
