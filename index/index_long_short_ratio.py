...
# -*- coding: utf-8 -*-
"""
指数多空比获取脚本 (Index Long/Short Ratio)
===========================================

调用 Primit 数据中心的两个多空比接口（同一份 schema，按 --type 选择）：
    GET https://api.pipai.org/index/v1/whaleLongShortRatio   鲸鱼（大户）多空比
    GET https://api.pipai.org/index/v1/topLongShortRatio     头部账户多空比
...
----
    时间序列数组，每个元素：
        {"symbol": "SPXUSDT", "longAccount": "0.60", "shortAccount": "0.40",
         "longShortRatio": "1.50", "timestamp": 1782360000000}
...
用法示例
--------
    python index/index_long_short_ratio.py                         # 默认 whale, SPX, 4h
    python index/index_long_short_ratio.py --type top --symbol NDX
    python index/index_long_short_ratio.py --period 1d --limit 60
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="获取 Primit 指数多空比 (whale / top long-short ratio)。",
